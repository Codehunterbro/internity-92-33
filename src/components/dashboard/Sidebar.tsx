...
const SidebarItem = ({ icon, label, to, isActive, isCollapsed, disabled = false }: SidebarItemProps) => {
  const content = (
    <div
  ...
  return (
    ...
    >
      ...
      <div className={`h-16 flex items-center ${isCollapsed ? 'justify-center' : 'px-6'} border-b border-gray-200`}>
        {!isCollapsed && (
          <Link to="/dashboard" className="flex items-center">
            <span className="text-xl font-bold text-brand-purple">INTERNITY</span>
          </Link>
        )}
        {isCollapsed && (
      ...
      <div className="p-4 border-t border-gray-200 space-y-1">
        ...
        {!isCollapsed && (
          <div className="bg-black rounded-lg p-4 text-white mb-4">
        ...
        <button
          ...
          className="mt-4 w-full flex items-center justify-center p-2 rounded-lg text-gray-600 hover:bg-gray-100 transition-colors"
        >
