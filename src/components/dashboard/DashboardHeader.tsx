...
const DashboardHeader = ({ onToggleSidebar }: DashboardHeaderProps) => {
  ...
  return (
    <header className="bg-white border-b flex items-center justify-between px-6 py-3 sticky top-0 z-10">
      ...
      <div className="flex items-center">
        ...
        <div className="relative hidden md:flex items-center">
          ...
          <Input 
            placeholder="Search..." 
            className="pl-10 w-[200px] lg:w-[300px] bg-gray-50"
          />
        </div>
      </div>
          ...
          <SheetTrigger asChild>
            ...
            >
              ...
              {selectedCourses.length > 0 && (
                <span className="absolute -top-1 -right-1 bg-brand-purple text-white text-xs rounded-full w-4 h-4 flex items-center justify-center">
